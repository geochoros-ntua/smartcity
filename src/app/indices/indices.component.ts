...
export class IndicesComponent implements OnInit {
  ...
  initialExtent: number[] = [
    2636520.1557000000029802, 4572119.5005000000819564,
    2648420.1557000000029802, 4584144.5005000000819564,
  ];
  ...
  variables: any = [
    ...
    },
    {
      ...
      name: 'AISTH_ESTI',
      label:
        '2.6: Ύπαρξη καταστημάτων εστίασης με τραπεζοκαθίσματα στον δημόσιο χώρο',
      level: 3,
      parent_index: 3,
      max: 0.0982,
    ...
    },
    {
      id: 8,
      name: 'AISTH_KATA',
      label: '2.2: Ύπαρξη κτηρίων σε καλή κατάσταση',
      level: 3,
      parent_index: 3,
      max: 0.1221,
    ...
    },
    {
      id: 9,
      name: 'AISTH_KTHR',
      label: '2.9: Ύπαρξη κτηρίων με μεγάλο ύψος (>=18.4μ. διάμεση τιμή)',
      level: 3,
      parent_index: 3,
      max: 0.0969,
    ...
    },
    {
      ...
      name: 'AISTH_KURI',
      label:
        '2.5 Κυριαρχία ισογείων με εμπορικές δραστηριότητες (≥60% του μήκους κάθε πλευράς ΟΤ)',
      level: 3,
      parent_index: 3,
      max: 0.099,
    ...
    },
    {
      ...
      name: 'AISTH_PEZO',
      label:
        '2.3: Ύπαρξη πεζοδρομίων με φυτεμένα παρτέρια (≥50% του μήκους κάθε πλευράς ΟΤ)',
      level: 3,
      parent_index: 3,
      max: 0.1212,
    ...
    },
    {
      id: 12,
      name: 'AISTH_PE_1',
      label: '2.1: Ύπαρξη διαδρομών με πεζοδρόμους',
      level: 3,
      parent_index: 3,
      max: 0.1612,
    ...
    },
    {
      ...
      name: 'AISTH_PRAS',
      label:
        '2.4: Ύπαρξη κτηρίων με πρασιά/προκήπιο (≥50% του μήκους κάθε πλευράς ΟΤ)',
      level: 3,
      parent_index: 3,
      max: 0.1221,
    ...
    },
    {
      ...
      name: 'AISTH_TOUR',
      label:
        '2.7: Συγκέντρωση τουριστικών ατραξιόν (π.χ. Μουσεία, Αρχαιολογικοί/Πολιτιστικοί χώροι κ.α. - δεδομένα από openstreetmap)',
      level: 3,
      parent_index: 3,
      max: 0.0977,
      desc: 'Ο δείκτης αξιολογεί την πυκνότητα σημείων τουριστικών ατραξιόν με βάση το openstreetmap.org. Η μέγιστη τιμή του κανονικοποιημένου & σταθμισμένου δείκτη είναι 0.0977. Πηγή δεδομένων: Openstreetmap.org (2023)',
    },
    {
      id: 16,
      name: 'ANE_THORIV',
      label: '1.5: Ύπαρξη δρόμων με χαμηλά επίπεδα θορύβου',
      level: 3,
      parent_index: 1,
      max: 0.112,
      desc: 'Ο δείκτης αξιολογεί την πυκνότητα δρόμων με χαμηλά επίπεδα θορύβου (<70db). Η μέγιστη τιμή του κανονικοποιημένου & σταθμισμένου δείκτη είναι 0.1120. Πηγή δεδομένων: Χάρτες Θορύβου Αθήνας, ΥΠΕΝ',
    },
    {
      id: 17,
      name: 'ANE_STOES_',
      label:
        '1.7: Ύπαρξη κτηρίων με κατά μήκος στοές (προστασία από καιρικά φαινόμενα) (≥25% του μήκους κάθε πλευράς ΟΤ)',
      level: 3,
      parent_index: 2,
      max: 0.1,
    ...
    },
    {
      id: 18,
      name: 'ANE_PEZODR',
      label: '1.1: Ύπαρξη διαδρομών με πεζοδρόμια χωρίς εμπόδια',
      level: 3,
      parent_index: 2,
      max: 0.2205,
    ...
    },
    {
      id: 21,
      name: 'ANE_DROM_1',
      label: '1.3: Ύπαρξη διαδρομών με δενδροστοιχίες (σκιά)',
      level: 3,
      parent_index: 2,
      max: 0.159,
    ...
    },
    {
      id: 22,
      name: 'ANE_DROM_2',
      label: '1.2: Ύπαρξη δρόμων ήπιας κυκλοφορίας',
      level: 3,
      parent_index: 2,
      max: 0.168,
    ...
    },
    {
      id: 23,
      name: 'EKSOP_BUS_',
      label: '5.5: Συγκέντρωση στάσεων που υπάρχει εξοχή του πεζοδρομίου',
      level: 3,
      parent_index: 5,
      max: 0.132,
    ...
    },
    {
      id: 24,
      name: 'EKSOP_BUS1',
      label: '5.4: Συγκέντρωση στάσεων με καλό επίπεδο καθαριότητας',
      level: 3,
      parent_index: 5,
      max: 0.133,
    ...
    },
    {
      ...
      name: 'EKSOP_BU_1',
      label:
        '5.6: Συγκέντρωση στάσεων με κάθισμα που βρίσκεται σε καλή κατάσταση',
      level: 3,
      parent_index: 5,
      max: 0.113,
    ...
    },
    {
      ...
      name: 'EKSOP_BU_2',
      label:
        '5.7: Συγκέντρωση στάσεων με καλή ορατότητα των διερχόμενων λεωφορείων και οχημάτων',
      level: 3,
      parent_index: 5,
      max: 0.107,
    ...
    },
    {
      ...
      name: 'EKSOP_BU_3',
      label:
        '5.3: Συγκέντρωση στάσεων με τοποθετημένο στέγαστρο σε καλή κατάσταση',
      level: 3,
      parent_index: 5,
      max: 0.14,
    ...
    },
    {
      id: 28,
      name: 'EKSOP_BU_4',
      label: '5.2: Συγκέντρωση στάσεων με τοποθετημένο ηλ.πίνακα τηλεματικής',
      level: 3,
      parent_index: 5,
      max: 0.168,
    ...
    },
    {
      ...
      name: 'EKSOP_Tran',
      label:
        '5.1: Συγκέντρωση στάσεων με υψηλότερη συχνότητα διερχόμενων δρομολογίων',
      level: 3,
      parent_index: 5,
      max: 0.206,
      desc: 'Ο δείκτης αξιολογεί την πυκνότητα των στάσεων των λεωφορείων σταθμισμένη με το μέσο όρο των ημερήσιων δρομολογίων ανά ώρα. Η μέγιστη τιμή του κανονικοποιημένου & σταθμισμένου δείκτη είναι 0.2060. Πηγή δεδομένων: GTFS OASA - https://archive.data.gov.gr/dataset/oasa-gtfs',
    },
    {
      id: 30,
      name: 'ODI_DIAVAS',
      label: '3.5: Συγκέντρωση διαβάσεων πεζών με λευκή διαγράμμιση (zebra)',
      level: 3,
      parent_index: 4,
      max: 0.1188,
    ...
    },
    {
      ...
      name: 'ODI_KOLONA',
      label:
        '3.7: Ύπαρξη πεζοδρομίων με προστατευτικά κολωνάκια ή κιγκλιδώματα (≥50% του μήκους κάθε πλευράς ΟΤ)',
      level: 3,
      parent_index: 4,
      max: 0.0767,
    ...
    },
    {
      id: 32,
      name: 'ODI_ODEFSI',
      label: '3.6: Ύπαρξη πεζοδρομίων με τοποθετημένη όδευση τυφλών',
      level: 3,
      parent_index: 4,
      max: 0.0891,
    ...
    },
    {
      id: 33,
      name: 'ODI_ODOFOT',
      label: '3.4: Συγκέντρωση στύλων οδοφωτισμού',
      level: 3,
      parent_index: 4,
      max: 0.1215,
      desc: 'Ο δείκτης αξιολογεί την πυκνότητα των σημείων που υπάρχουν τοποθετημένοι στύλοι οδοφωτισμού. Η μέγιστη τιμή του κανονικοποιημένου & σταθμισμένου δείκτη είναι 0.1215. Πηγή δεδομένων: Αυτοματοποιημένη αναγνώριση σημείων από αλγόριθμους αξιολόγησης πανοραμικών εικόνων της υπηρεσίας mapillary.org',
    },
    {
      id: 34,
      name: 'ODI_PAGKAK',
      label: '3.8: Συγκέντρωση αστικών καθιστικών (παγκάκια)',
      level: 3,
      parent_index: 4,
      max: 0.074,
      desc: 'Ο δείκτης αξιολογεί την πυκνότητα των σημείων που υπάρχουν παγκάκια. Η μέγιστη τιμή του κανονικοποιημένου & σταθμισμένου δείκτη είναι 0.0740. Πηγή δεδομένων: Τμήμα Γεωχωρικών Δεδομένων Δήμου Αθηναίων (καταγραφές 2017 & 2019)',
    },
    {
      id: 35,
      name: 'ODI_PEZODR',
      label: '3.2: Συγκέντρωση πεζοδρομίων σε καλή κατάσταση',
      level: 3,
      parent_index: 4,
      max: 0.1713,
    ...
    },
    {
      id: 36,
      name: 'ODI_PEZO_1',
      label: '3.1: Συγκέντρωση πεζοδρομίων με μεγάλο (> 2μ) και σταθερό πλάτος',
      level: 3,
      parent_index: 4,
      max: 0.1759,
    ...
    },
    {
      id: 37,
      name: 'ODI_PLHROF',
      label: '3.9: Συγκέντρωση πεζοδρομίων με πληροφοριακές (καφέ) πινακίδες',
      level: 3,
      parent_index: 4,
      max: 0.0503,
    ...
    },
    {
      ...
      name: 'ODI_RAMPES',
      label:
        '3.3: Συγκέντρωση ραμπών ΑμΕΑ που βρίσκονται σε καλή κατάσταση στις άκρες των διαβάσεων πεζών',
      level: 3,
      parent_index: 4,
      max: 0.1224,
    ...
    },
    {
      id: 39,
      name: 'POL_METRO_',
      label: '4.2: Πυκνότητα σταθμών ΜΕΤΡΟ',
      level: 3,
      parent_index: 44,
      max: 0.2131,
      desc: 'Ο δείκτης αξιολογεί την πυκνότητα των σταθμών ΜΕΤΡΟ. Η μέγιστη τιμή του κανονικοποιημένου & σταθμισμένου δείκτη είναι 0.2131. Πηγή δεδομένων: Γεωπύλη Δήμου Αθηναίων - http://gis.cityofathens.gr',
    },
    {
      id: 40,
      name: 'POL_MIXEDU',
      label: '4.1: Συγκέντρωση περιοχών με μεικτές χρήσεις γης ',
      level: 3,
      parent_index: 44,
      max: 0.2535,
    ...
    },
    {
      id: 41,
      name: 'POL_POP201',
      label: '4.4: Πυκνότητα πληθυσμού ανά ΟΤ (ΕΛΣΤΑΤ 2011)',
      level: 3,
      parent_index: 44,
      max: 0.1713,
      desc: 'Ο δείκτης αξιολογεί την πυκνότητα πληθυσμού ανά ΟΤ. Η μέγιστη τιμή του κανονικοποιημένου & σταθμισμένου δείκτη είναι 0.1713. Πηγή δεδομένων: Στοιχεία Απογραφής Πληθυσμού ΕΛΣΤΑΤ, 2011',
    },
    {
      id: 42,
      name: 'POL_PT_STO',
      label: '4.3: Πυκνότητα στάσεων λεωφορείων/τρόλεϊ/τράμ',
      level: 3,
      parent_index: 44,
      max: 0.2103,
      desc: 'Ο δείκτης αξιολογεί την πυκνότητα στάσεων λεωφορείων/τρόλεϊ/τράμΟ. Η μέγιστη τιμή του κανονικοποιημένου & σταθμισμένου δείκτη είναι 0.2103. Πηγή δεδομένων: GTFS OASA - https://archive.data.gov.gr/dataset/oasa-gtfs',
    },
    {
      id: 43,
      name: 'POL_PYKNOT',
      label: '4.5: Πυκνότητα διασταυρώσεων οδικού δικτύου',
      level: 3,
      parent_index: 44,
      max: 0.1518,
  ...
  ngAfterViewInit(): void {
    ...
    this.map.once('postrender', () => (this.mapReady = true));
    ...
    this.indexSource.once('featuresloadend', (response: any) => {
      this.breakPoints[0] = Math.min(
        ...this.indexSource
          .getFeatures()
          .map((f) => f.get(this.selectedVariableName))
      );
      this.breakPoints[5] = Math.max(
        ...this.indexSource
          .getFeatures()
          .map((f) => f.get(this.selectedVariableName))
      );
    ...
    this.map.on('click', (e: any) => {
      for (
        let index = 0;
        index < this.previousSelectedFeatures.length;
        index++
      ) {
            ...
            if (layer.className_ === 'indices') {
              if (feature) {
                ...
                for (let index = 0; index < this.variables.length; index++) {
                  ...
                  element.value =
                    Math.round(feature.get(element.name) * 1000) / 1000;
...
export class indicesFilterPipe implements PipeTransform {
  transform(indices: any[], filter: any): any {
    ...
    return indices.filter(
      (item) =>
        item.level === filter.level && item.parent_index === filter.parent_index
    );
  }
}

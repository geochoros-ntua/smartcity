...
export class TeamComponent {
  team = [
    ...
    {
      name: 'Κώστας Αθανασόπουλος',
      title: 'Δρ. ',
      description: 'Ε.ΔΙ.Π. Ε.Μ.Π., Πολιτικός Μηχανικός Ε.Μ.Π.',
      email: 'kathanas.civil@gmail.com',
      img: 'assets/images/athanasopoulos.jpg',
      rid: '-',
    },
    {
      name: 'Παύλος Τσάγκης',
    ...
    },
    {
      ...
      title: '',
      description:
        'Υπ. Διδάκτορας Ε.Μ.Π., Αγρονόμος-Τοπογράφος Μηχανικός Ε.Μ.Π.',
      email: '',
      img: 'assets/images/karolemeas.jpg',
